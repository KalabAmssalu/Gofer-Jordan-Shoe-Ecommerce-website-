            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 py-3">
                        <img src="<?php echo $item['item_image'] ?? ".assets/image/Jordan Shoes/zachary-keimig-wT_vIwtVnjk-unsplash.jpg" ?>" alt="product" class="img-fluid">
                    ...
                    <div class="col-sm-6 py-5">
                        ...
                        <table class="my-3">
                            ...
                            <tr class="font-rale font-size-14">
                                <td>You Save:</td>
                                <td><span class="font-size-16 text-danger">500ETB</span></td>
                            </tr>
                        </table>
                        <!---    !product price       -->
                        ...
                        <div id="order-details" class="font-rale d-flex flex-column text-dark">
                            ...
                            <small>Sold by <a href="#">GOFER SHOP</a>(4.5 out of 5 | 18,198 ratings)</small>
                        ...
                        <div class="size my-3">
                            ...
                            <div class="d-flex justify-content-between w-75">
                                <div class="font-rubik border p-2">
                                    <button class="btn p-0 font-size-14">42</button>
                                </div>
                                <div class="font-rubik border p-2">
                                    <button class="btn p-0 font-size-14">41</button>
                                </div>
                                <div class="font-rubik border p-2">
